...
<head>
    ...
    <link href="edit user profile0.css" rel="stylesheet">
...
<body>
    <header>
            ...
            <a href="http://localhost/Library_Management_System/show user.php" id="p0" style="margin-top:-7px;"><i class="fa fa-sign-out"></i>Feedback</a>

     <br> <br>
     <div class="logo" id="logo" style=""><img src="img/9.png"></div>

        <form action="" method="post">
         <div class="title"><div id="line5"></div><span id="type1">Edit_profile</span></div>
             <br> <br>
...
<?php
    ...
    if($count==0){
        if(mysqli_query($db,"UPDATE `student` SET first='$_POST[first]',email= '$_POST[email]',password='$_POST[password]',contact='$_POST[contact]'  WHERE last='$_POST[last]';"))
        ?>
