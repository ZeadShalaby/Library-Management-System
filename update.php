...
<head>
    ...
    <link href="update00.css" rel="stylesheet">
...
<body>
    <header>
     ...
     <div class="logo" id="logo"><img src="img/9.png"></div>
        ...
        <form action="" method="post">
         <div class="title"><div id="line5"></div><span id="type1">UPDATA_BOOKS</span></div>
             <br> <br>
            ...
            <input type="password"  name="edition"  placeholder="edition" required="">
            <input type="password1" name="status"  placeholder="status" required="">
            <input type="password2" name="quantity"  placeholder="Quantity" required="">
            <input type="password3" name="department"  placeholder="departement" required="">
            <br> <br>
              
   
            <br>
             <input type="submit" name="submit" id="buy" value="Edit">
  ...
  <a href="http://localhost/Library_Management_System/login.php"><i class="fa fa-fw fa-home">Admin</i></a>
    ...
    <a href="http://localhost/Library_Management_System/delete.php"><i class="fas fa-remove-format">Delete</i></a>
</div>
...
<?php
    ...
    if($count==0){
        ...
        if(mysqli_query($db,"UPDATE `books` SET name='$_POST[name]',authors='$_POST[authors]',edition= '$_POST[edition]',status='$_POST[status]',quantity='$_POST[quantity]',department='$_POST[department]'  WHERE bid='$_POST[bid]';"))
        ?>
          <script type="text/javascript">
